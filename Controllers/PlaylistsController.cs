...
namespace SpotifyWebAPI_Intro.Controllers
{
    ...
    public class PlaylistsController : ControllerBase
    {
        ...
        public PlaylistsController(SessionService sessionService, HttpService httpService, TokenHelper token, ILogger<PlaylistsController> logger)
        {
        ...
        public async Task<IActionResult> GetPlaylistsAsync()
        {
            ...
            var response = await _httpService.GetHttpResponseAsync(endPoint);
